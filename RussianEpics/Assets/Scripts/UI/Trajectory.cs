...
public class Trajectory : MonoBehaviour
{
    ...
    public void UpdateDots(Vector3 bowPos, Vector2 forceApplied)
    {
        timeStamp = dotSpacing;
        for (int i = 0; i < dotsNumber; i++)
        {
            pos.x = (bowPos.x + forceApplied.x * timeStamp);
            pos.y = (bowPos.y + forceApplied.y * timeStamp) - (Physics2D.gravity.magnitude * timeStamp * timeStamp);
